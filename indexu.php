...
<!-- header -->
	...
	<div class="w3_navigation" style="background-color: #000">
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="#">STAR <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#availability" class="menu__link scroll">Avalability</a></li>
							<li class="menu__item"><a href="#team" class="menu__link scroll">Team</a></li>
							<li class="menu__item"><a href="#gallery" class="menu__link scroll">Gallery</a></li>
							<li class="menu__item"><a href="#rooms" class="menu__link scroll">Rooms</a></li>
							<li class="menu__item"><a href="#contact" class="menu__link scroll">Contact Us</a></li>
                            <li class="menu__item"> <h6 style="font-size: 15px; color: white">Welcome <?php
           if(isset($_SESSION['username']))
         {
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation.php"><h2  style="background-color: #e37207">ROOM RESERVATION</h2></a>
</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">STAT HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">STAR HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
...
<!-- //banner-bottom -->
<header id="availability" style="max-width:1500px; padding-top: none;margin-top: none; position: center;margin: auto ;">
  
  <div class="w3-display-left w3-padding w3-col l6 m8">
    <div class="w3-container w3-red">
      <h2><i class="fa fa-bed w3-margin-right"></i>Star Hotel</h2> </br>
    </div>
    <div class="w3-container white w3-padding-16">
      <form action="admin/avail.php" target="_blank">
        <div class="w3-row-padding" style="margin:0 -16px;">
          <div class="w3-half w3-margin-bottom">
            <label><i class="fa fa-calendar-o"></i> Check In</label>
            <input class="w3-input w3-border" type="date" placeholder="DD MM YYYY" name="CheckIn" required style="margin-bottom: 20px;">
          </div>
          <div class="w3-half">
            <label><i class="fa fa-calendar-o"></i> Check Out</label>
            <input class="w3-input w3-border" type="date" placeholder="DD MM YYYY" name="CheckOut" required style="margin-bottom: 20px;>
          </div>
        </div>
        <div class="w3-row-padding" style="margin:8px -16px;">
          <div class="w3-half w3-margin-bottom">
            <label><i class="fa fa-male"></i> Adults</label>
            <input class="w3-input w3-border" type="number" value="1" name="Adults" min="1" max="6" style="margin-bottom: 20px;>
          </div>
          <div class="w3-half">
...
<!-- /contact -->
			<div class="copy" style="background-color: #000;">
		        <p>© 2018 SUNRISE . All Rights Reserved | Design by <a href="index.php">Our Team</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
