        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
					...
					<div class="panel-body">
						...
						if(empty($newus) or empty($newps))
                        {
                         ...
                         alert('please enter a information');
                            ...
                            $ad  =  new admin($newus , $newps,"admin@yahoo.com");
                            $ad->addNewAdmin($newus , $newps) ;
				...
				if(isset($_POST['up']))
				{
                    ...
                    $a =new admin($usname,$passwr,"admin@yahoo.com");
                    $a->update($usname , $passwr ,$id);
